...
namespace coredump
{
    ...
    public:
        // Constructor
        Position() : whitePawns(0), whiteKnights(0), whiteBishops(0), whiteRooks(0), whiteQueens(0), whiteKing(0),
        ...
        uint64_t getOccupiedSquares() { return getWhitePieces() | getBlackPieces(); }
        uint64_t getEmptySquares() { return ~getOccupiedSquares(); }
